// Add integers from the list; ignore null values;
...
class Main {
    public static void main(String[] args) {
        ...
        Integer total = 0;
        for (Optional<Integer> optValue : provider.getValues()) {
            // Integer value = Optional.ofNullable(optValue).orElse(Integer.valueOf(0));
