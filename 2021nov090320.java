...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        final String TEMPLATE_SUCCESS = "%s lives at %s";
        final String TEMPLATE_FALLBACK = "Unknown";
        optAddress.ifPresentOrElse((address) -> System.out.printf(TEMPLATE_SUCCESS, name, address),
                () -> System.out.println(TEMPLATE_FALLBACK));
    }
}
